...
<![endif]-->
	...
	<script type="text/javascript">
		jQuery(function($) {
			...
			//获取菜单
//			quickAjax({
//				url: 'http://localhost:8082/admin/menu/get',
...
//										$("#nav").append('<li ><a href="javascript:addTabs({id:\''+item.id+'\',title: \''+item.name+'\',close: true,url: \''+item.url+'\'})"> <i class="menu-icon fa fa-tachometer"></i> <span class="menu-text">'+item.name+' </span></a></li>');
//									}else{
//										$("#nav").append('<li ><a class="dropdown-toggle" href="javascript:addTabs({id:\''+item.id+'\',title: \''+item.name+'\',close: true,url:\''+item.url+'\'})"> <i class="menu-icon fa fa-tachometer"></i> <span class="menu-text">'+item.name+' </span><b class="fa fa-angle-down arrow"></b></a><ul class="submenu" style="display: none;" id="nav'+item.id+'">');
//										$(item.children).each(function (i,children) {
//											$("#nav"+children.parentId).append('<li><a href="javascript:addTabs({id:\''+children.id+'\',title:\''+children.name+'\',close: true,url: \''+children.url+'\'})"> <i class="menu-icon fa fa-tachometer"></i> <span class="menu-text">'+children.name+' </span></a></li>');
//										});
//
//										$("#nav").append('</ul></li>');
//
